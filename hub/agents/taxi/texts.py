...
GREETING = (
    ...
    "Дальше я сам:\n"
    "• обновляю карточку заказа, пока курьер едет;\n"
    "• присылаю отдельное сообщение за столько минут до прибытия, "
    "за сколько попросите (по умолчанию за 5);\n"
    "• говорю, когда курьер будет на месте.\n\n"
    "Интервал меняется кнопками под карточкой — можно включить несколько сразу, "
    "например за 15 и за 5 минут. Нужного значения нет — «⏱ Свой интервал».\n\n"
    "Команда /list покажет, за чем я сейчас слежу."
)
