/* Обвязка отдельной страницы «Товары».

   Каталог лежит в базе панели, собранный заранее. К площадке страница
   ходит только за оценкой конкретной карточки, и только когда её открыли.
...
(function (global) {
  ...
  function openPage() {
    ...
    global.Products.mount(dom['products-body']);
  }

  function init() {
    ['gate', 'gate-form', 'gate-password', 'gate-error', 'page', 'products-body',
    ...
    dom['btn-reload'].addEventListener('click', function () { global.Products.reload(); });
